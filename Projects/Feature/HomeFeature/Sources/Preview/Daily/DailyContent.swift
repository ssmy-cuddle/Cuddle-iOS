...
public struct DailyContent {
    ...
    public struct State: Equatable {
        var contents: [DailyContentGridItemModel] = MockDailyContentGridItemModel.itemModels
    }
}
...
enum MockDailyContentGridItemModel {
    ...
    static var itemModels: [DailyContentGridItemModel] {
        [
            DailyContentGridItemModel(
                id: UUID(),
